...
- `utils/scripts/Video`: This folder contains the script to generate vector embeddings for video modality using ResNet50 after extracting keyframes using OpenCV and averaging them.
