...
if __name__ == "__main__":
    ...
    train_data_file = "/Users/anjelica/Downloads/labeled_train_datafinal.json"      # CSV with a column "text"
    test_data_file = "/Users/anjelica/Downloads/test_data.json"          # CSV with a column "text"
    val_data_file = "/Users/anjelica/Downloads/val_data (1).json"
...
# def extract_features(model, train_dataframe, text_column="text_cleaned"):
#     """Extract features using the trained FastText model."""
#     X_features = []
#     y_labels = []
    
#     print("Extracting features...")
#     for _, row in tqdm(train_dataframe.iterrows(), total=len(train_dataframe)):
...
#     # Save y_labels
#     pd.DataFrame(y_labels, columns=['emotion']).to_csv("y_labels.csv", index=False)
...
#     train_df.to_csv(f"processed_data_{cleaning_method}.csv", index=False)
    
#     # 11. Save feature data
#     print("\n=== Saving Feature Data ===")
#     feature_df = pd.DataFrame(X_features)
#     feature_df['emotion'] = y_labels
#     feature_df.to_csv(f"features_{cleaning_method}.csv", index=False)
...
#     limit = 50 # Set to None to process all data
