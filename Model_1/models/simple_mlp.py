...
# Remaining parts (train_epoch, evaluate, get_class_weights, plotting functions) remain unchanged
...
def main():
    ...
    parser.add_argument('--train_video', required=True)
    parser.add_argument('--train_labels', required=True)
    parser.add_argument('--test_text', required=True)
    parser.add_argument('--test_video', required=True)
    parser.add_argument('--test_labels', required=True)
    parser.add_argument('--output_dir', default='./results')
    parser.add_argument('--n_splits', default=5, type=int)
    parser.add_argument('--ensemble', action='store_true')
    parser.add_argument('--val_text',    required=True)
    parser.add_argument('--val_video',   required=True)
